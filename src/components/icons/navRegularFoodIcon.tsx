...
const NavRegularFoodIcon = ({ className, ...props }: SvgProps) => (
  <svg
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M9.75 12V8.5a.5.5 0 0 1 .5-.5h3a1.5 1.5 0 0 1 1.5 1.5v1a1.5 1.5 0 0 1-1.5 1.5H11.5m-1.75 0v4m0-4h1.75m0 0 3 4"
    />
    <path
      stroke="#314158"
      strokeLinecap="round"
